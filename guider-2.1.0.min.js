...
r(8224);a.s.onShow&&a.s.onShow.call(a.e);a.e.css("display","block");for(h in a.s.buttons)a.s.buttons[h].focus&&a.e.find(":contains("+h+")").focus();window.scrollTo(0>(h=a.e.offset()).left-(d=i(window).scrollLeft())||h.left+(b=a.e.width())>d+(g=i(window).width())?Math.max(h.left+(b-g)/2,0):d,0>h.top-(d=i(window).scrollTop())||h.top+(b=a.e.height())>d+(g=i(window).height())?Math.max(h.top+(b-g)/2,0):d)}var x={title:"This is a very generic title.",description:"Did you forget a description?",width:530,
